...
const MidiaSocial = () => (
    <Row>
        <Col md='3' sm='3' xs='3' title='Instagram'>
        ...
        <Col md='3' sm='3' xs='3' title='GitHub'>
        ...
        <Col md='3' sm='3' xs='3' title='LinkedIn'>
        ...
        <Col md='3' sm='3' xs='3' title='WhatsApp'>
            <a href='https://web.whatsapp.com/send?phone=5516997073659&text=Ol%C3%A1+Jos%C3%A9+Henrique%2C+tudo+bem%3F+Encontrei+seu+n%C3%BAmero+atrav%C3%A9s+do+seu+portf%C3%B3lio+online.' target='_blank' rel="noopener noreferrer">
                <div className="card mb-3 bg-dark widget-chart text-white card-border">
